...
func TestSliceString_Required(t *testing.T) {
	type Params struct {
		Names []string `descr:"List of names"`
	}
...
func TestSliceString_Optional(t *testing.T) {
	type Params struct {
		Tags []string `descr:"List of tags" optional:"true"`
	}
...
func TestSliceString_Default(t *testing.T) {
	type Params struct {
		Modes []string `descr:"Operation modes" default:"read,write" optional:"true"`
	}
...
func TestSliceString_EnvVar(t *testing.T) {
	type Params struct {
		Hosts []string `descr:"List of hosts" env:"TEST_HOSTS"`
	}
...
func TestSliceInt_Optional(t *testing.T) {
	type Params struct {
		Numbers []int `descr:"List of numbers" optional:"true"`
	}
...
func TestSliceInt_Default(t *testing.T) {
	type Params struct {
		Limits []int `descr:"Limits" default:"100,200" optional:"true"`
	}
...
func TestSliceInt32_Required(t *testing.T) {
	type Params struct {
		Values []int32 `descr:"List of values"`
	}
...
func TestSliceInt32_Optional(t *testing.T) {
	type Params struct {
		Nums []int32 `descr:"List of numbers" optional:"true"`
	}
...
func TestSliceInt64_Required(t *testing.T) {
	type Params struct {
		Timestamps []int64 `descr:"List of timestamps"`
	}
...
func TestSliceInt64_Optional(t *testing.T) {
	type Params struct {
		BigNums []int64 `descr:"List of big numbers" optional:"true"`
	}
...
func TestSliceFloat32_Required(t *testing.T) {
	type Params struct {
		Rates []float32 `descr:"List of rates"`
	}
...
func TestSliceFloat32_Optional(t *testing.T) {
	type Params struct {
		Factors []float32 `descr:"List of factors" optional:"true"`
	}
...
func TestSliceFloat64_Required(t *testing.T) {
	type Params struct {
		Coords []float64 `descr:"List of coordinates"`
	}
...
func TestSliceFloat64_Optional(t *testing.T) {
	type Params struct {
		Prices []float64 `descr:"List of prices" optional:"true"`
	}
...
func TestSliceFloat64_Default(t *testing.T) {
	type Params struct {
		Thresholds []float64 `descr:"Thresholds" default:"0.5,0.75,0.9" optional:"true"`
	}
...
func TestSlice_SingleElement(t *testing.T) {
	type Params struct {
		Values []int `descr:"List of values"`
	}
